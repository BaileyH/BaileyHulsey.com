...
"x86_64-linux-thread-multi-4.17.11-arch1" or
	die "Errno architecture (x86_64-linux-thread-multi-4.17.11-arch1) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
